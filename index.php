...
<div class="addError message" style="display:none">
...
<div class="form-group">
        ...
        <input type="text" id="locationID" value="Enter your location ID" class="form-control" required>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="" method="POST">
        ...
        <input type="text" id="firstName" value="Enter First Name" class="form-control" required />
</div>
<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="" method="POST">
        ...
        <input type="text" id="location" value="Enter location" class="form-control" required>
</div>
