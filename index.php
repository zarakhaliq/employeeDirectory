...
<div class="container" id="buttons">
 ...
 del" data-toggle="modal" data-target="#exampleModal3">
    Delete Department
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
        <label> ID </label>
        <input type="text" id="removeID" value="" class="form-control" required>
</div>
         <!--
...
<select class="form-control" id="oldDep" name="name" required>
...
<div class="form-group">
<label for="loc">New Department</label>
<select class="form-control" id="dep" name="name" required>
...
<div class="form-group">
  <label for="loc">Location</label>
<select class="form-control" id="oldLocation" name="name" required>
...
<select class="form-control" id="newLoc" name="name" required>
